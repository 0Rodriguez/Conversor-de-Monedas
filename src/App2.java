...
public class App2 extends JFrame {
	...
	public App2() {
		...
		JButton boton3 = new JButton("Conversor de Temperatura");
		boton3.setSize(new Dimension(288, 41));
		boton3.setFont(new Font("Poppins", Font.PLAIN, 11));
		boton3.setBackground(Color.WHITE);
		boton3.setBounds(23, 214, 288, 41);
		...
		JLabel lblNewLabel = new JLabel("Developed By Oscar Rodríguez");
